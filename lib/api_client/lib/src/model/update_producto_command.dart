...
part 'update_producto_command.g.dart';
...
/// * [cantidadDisponible] 
@BuiltValue()
abstract class UpdateProductoCommand implements Built<UpdateProductoCommand, UpdateProductoCommandBuilder> {
  ...
  UpdateProductoCommand._();

  factory UpdateProductoCommand([void updates(UpdateProductoCommandBuilder b)]) = _$UpdateProductoCommand;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpdateProductoCommandBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpdateProductoCommand> get serializer => _$UpdateProductoCommandSerializer();
}

class _$UpdateProductoCommandSerializer implements PrimitiveSerializer<UpdateProductoCommand> {
  @override
  final Iterable<Type> types = const [UpdateProductoCommand, _$UpdateProductoCommand];

  @override
  final String wireName = r'UpdateProductoCommand';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UpdateProductoCommand object, {
  ...
  void _deserializeProperties(
    ...
    required UpdateProductoCommandBuilder result,
  ...
  @override
  UpdateProductoCommand deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UpdateProductoCommandBuilder();
